...
log2Term = function(re){
    ...
    console.info(printf('%15s: %s -----> %s'.em, 'Trading Date',
    ...
    if(stat.netBuyAmt.indexOf('-') < 0){
        ...
        console.info(printf('%15s: %16s   Net Sell Shares'.em, 'Net Shares', stat.netBuyAmt.replace('-', '')));
    }
    ...
    if(stat.netBuyVal.indexOf('-') < 0){
        ...
        console.info(printf('%15s: %16s   Net Proceeds'.em, 'Net Values', stat.netBuyVal.replace('-', '')));
    }
    console.info(printf('%15s: %9s  '.em, 'Mean Buy  Price', stat.meanBuyPrice));
    console.info(printf('%15s: %9s\n'.em, 'Mean Sell Price', stat.meanSellPrice));
